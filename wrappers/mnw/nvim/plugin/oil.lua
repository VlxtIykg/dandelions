...
-- https://github.com/llakala/meovim/commit/7642636cce3cab30a32f2b26e99a10fe08837cd7
...
local function add_to_qflist()
  ...
  vim.g.open_qf_on_quit = true -- Llak have this handled in the oil ftplugin
end
...
oil.setup({
  ...
  keymaps = {
    ...
    ["<C-l>"] = {
      "actions.select",
      opts = {
        -- This is in Llaks personal fork
        confirm = false,
      },
    },
