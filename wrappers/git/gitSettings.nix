{ inputs }:
{
  # user.signingkey = if options.signingKey != null then options.signingKey else null;
  # user.signingkey = lib.modules.mkIf options.signingKey != null {
  #   options.signingKey;
  # }
